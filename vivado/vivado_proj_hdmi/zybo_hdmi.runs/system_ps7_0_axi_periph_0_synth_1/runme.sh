...
HD_PWD='C:/Users/user/Documents/AAD/space_invaders/vivado/vivado_proj_hdmi/zybo_hdmi.runs/system_ps7_0_axi_periph_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ps7_0_axi_periph_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ps7_0_axi_periph_0.tcl
